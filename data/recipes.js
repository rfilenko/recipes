export const RECIPES_LIST = [
  ...
  },
  {
    ...
    ingridients: [
      ...
      [
        2.5,
        'lbs (0.45 kgs) Granny Smith Apples peeled, cored  6-7 apples (7 cups thinly sliced)',
      ],
      [1.5, 'tsp cinnamon'],
  ...
  },
  {
    ...
    ingridients: [
      ...
      [null, 'sea salt'],
      [null, 'black pepper'],
      [null, 'handful freshly chopped parsley'],
      [null, '1 lemon'],
    ],
    instructions: [
  ...
  },
  {
    ...
    ingridients: [
      ...
      [2, 'cm z kořene zázvoru'],
      [1, 'lžička kokosovych aminos'],
      [null, 'súl'],
      [null, 'pepř'],
      [null, 'kopr'],
      [null, 'šťáva z bio citronu'],
    ],
    instructions: [
  ...
  },
  {
    ...
    ingridients: [
      ...
      [6, 'plátků másla'],
      [6, 'stonků čerstvého tymiánu'],
      [2, 'velké hrsti čerstvého špenátu'],
      [null, 'sůl'],
      [null, 'pepř'],
      [null, 'ghi nebo domácí sádlo'],
    ],
    instructions: [
    ...
    modifications: [
      ...
      },
      {
        ...
        list: [
          ...
          [null, 'сметана для подачі'],
          [null, 'чорний мелений перець до смаку'],
        ],
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingridients: [
      [1.5, 'kg vepřových žeber'],
      [4, 'lžíce dijonské hořčice'],
      [6, 'stroužků česneku'],
      [1, 'lžíce cerstvého roymarýnu'],
      [2, 'hrnky vody'],
      [null, 'sůl'],
      [null, 'pepř'],
    ],
  ...
  },
  {
    ...
    ingridients: [
      ...
      [
        1,
        'tablespoon oil (use a neutral oil such as sunflower, canola, or rice bran oil)',
      ],
      [1, 'pinch salt'],
    ],
    instructions: [
  ...
  },
  {
    ...
    ingridients: [
      ...
      [1 / 2, 'ч.ложки солі'],
      [1 / 2, ' ч.ложки соди'],
      [100, 'мл води кімнатної температури'],
    ],
    modifications: [
      {
        title: 'Для начинки',
...
Пока яблочный пирог печется в духовке, аромат разносится по всему подъезду - просто невозможно удержаться, чтобы не попробовать кусочек горячей, еще дышащей паром шарлотки сразу, как ее только свежеиспеченную и горячую вынимают из духовки. Вокруг шарлотки собирается вся семья! Дети любят яблочную шарлотку с молоком, а взрослые предпочитают с горячим чаем без сахара - сладости и в шарлотке достаточно!`,
    ingridients: [
      ...
      [null, 'сливочное или растительное масло (для смазывания формы)'],
    ],
    instructions: [
  ...
  {
    name: 'Панна котта с клубничным желе',
    id: 19,
    type: 'liked',
    servings: 8,
    slugUrl: 'panna-cotta',
    ...
    modifications: [
      {
        ...
        list: [
          ...
          [50, 'г. сахара'],
          [2, 'ч.л. желатина'],
          [6, 'шт. клубники для украшения'],
        ],
      },
    ],
    instructions: [
      'Желатин залить 4 ст.л. холодной воды и оставить на 5 минут.',
      'Влить смесь в миску с желатином и размешать до полного его растворения.Разлить смесь в 6 бокалов.Дать остыть до комнатной температуры и отправить в холодильник на 2 - 3 часа.',
      'Приготовить клубничное желе.Желатин залить 2 ст.л.воды и дать набухнуть в течение 5 - 7 минут. ',
      'Клубнику положить в кастрюлю, добавить сахар и 3 ст.л.воды.Варить, помешивая, до растворения сахара.Пюрировать ягоды с помощью блендера.Влить горячее пюре в миску с желатином и размешать до полного растворения.Дать остыть до комнатной температуры. ',
      '6. Вылить клубничную массу поверх застывшей панна котты и поставить в холодильник до полного застывания.Подавать, украсив свежей клубникой.',
      'Сливки и молоко влить в небольшую кастрюлю, добавить сахар.Поставить кастрюлю на огонь и довести до кипения, постоянно помешивая.Снять с огня.',
    ],
    time_prep: '30 мин.',
    time_cook: '2 - 3 часа',
    time_total: '3 часа 30 мин.',
    image:
      'https://res.cloudinary.com/dq1embvfh/image/upload/v1594114567/panna-cotta.jpg',
  },
  {
    name: 'Рецепт жаркого из свинины с картошкой',
    id: 20,
    type: 'liked',
    servings: 6,
    ...
    ingridients: [
      ...
      [1, 'сухие ароматные травы'],
      [null, 'чайная ложка (по щепотке - орегано, базилик, прованские травы)'],
      [1, 'ч.л. паприка молотая'],
    ],
    instructions: [
      'Мясо тщательно промоем, обсушим и нарежем небольшими кусочками. Обжарим на сковороде или в толстостенной кастрюле до легкой румяной корочки.',
      'Очистим морковь, нарежем на кусочки и обжарим отдельно от мяса до изменения цвета.',
      'Добавим морковь к обжаренному мясу.',
      'Добавим муку, перемешиваем и обжариваем минуту-полторы, при этом все время помешивая.',
      'Добавим к мясу стакан воды и тщательно перемешаем, чтобы мука хорошо разошлась в будущем соусе. Добавим еще стакан воды, половину соли и все специи. Готовим минут 15.',
      'И готовим наше жаркое до мягкости картофеля. Если вам не нужно много соуса в блюде, можно приоткрыть крышку — и пусть лишняя жидкость испарится.',
      'Когда мясо будет практически готово, добавим к нему очищенный картофель. Если у вас крупный картофель, нарежем его на 4-6 частей. Добавим оставшуюся соль.',
      'И вот жаркое готово, посыпаем свежей яркой зеленью и подаем к столу.',
    ],
    time_prep: '30 мин.',
    time_cook: '1 час',
    time_total: '1 час 30 мин.',
    image:
      'https://res.cloudinary.com/dq1embvfh/image/upload/v1602319834/zharkoe-svinina.jpg',
  },
  {
    name: 'Pečený králík - jednoduše a chutně',
    id: 21,
    type: 'liked',
    servings: 6,
    slugUrl: 'peceny-kralik',
    lang: 'cz',
    tags: ['králík'],
    category: ['main dish'],
    description: `Králičí maso je jedno z nejlépe stravitelných mas. Obsahuje málo cholesterolu a hodně bílkovin. Je pochoutkou české kuchyně, kterou je možné připravit mnoha způsoby.`,
    ingridients: [
      [1, 'ks králík'],
      [1, 'ks cibule větší'],
      [null, 'sůl'],
      [4, 'stroužek česnek'],
      [null, 'kmín'],
      [null, 'špek může být i anglická'],
    ],
    instructions: [
      'Králíka rozporcujeme, osolíme, prošpikujeme a dáme do pekáče.',
      'Přidáme nakrájenou cibuli,česnek a pokmínujeme. Můžeme přidat trochu másla a podlijeme.',
      'Pečeme při 200 C° / 2 hodiny /zakryté 90 min, 30 min dopékáme odkryté, aby se nám vytvořila kůrčička. Dobrou chuť!',
    ],
    time_prep: '30 min.',
    time_cook: '1 hodina',
    time_total: '1 hodina 30 min.',
    image:
      'https://res.cloudinary.com/dq1embvfh/image/upload/v1603628397/kralik.jpg',
  },
  {
    ...
    type: 'liked',
    servings: 5,
    slugUrl: 'spaghetti-bolognese',
    lang: 'en',
    tags: ['spaghetti', 'bolognese'],
    category: ['main dish'],
    description: `The Bolognese Sauce is rich, thick and has beautiful depth of flavour. It’s perfect for a quick midweek meal though if you have the time to simmer this Meat Sauce for a couple of hours, you’ll take it from seriously delish to OMG this is amazing!!`,
    ingridients: [
      [1.5, 'tbsp olive oil'],
      [2, 'garlic cloves, minced'],
      [1, 'onion, finely chopped (brown, yellow or white)'],
      [500, 'g beef mince (ground beef) or half pork, half beef'],
      [1 / 2, 'cup dry red wine (sub water or beef broth/stock)'],
      [2, 'beef bouillon cubes , crumbled OR granulated beef bouillon'],
      [800, 'can crushed tomato (or tomato passata)'],
      [2, 'tbsp tomato paste'],
      [2, 'tsp white sugar , if needed'],
      [2, 'tsp Worcestershire sauce'],
      [2, 'dried bay leaves'],
      [2, 'sprigs fresh thyme (or 1/2 tsp dried thyme or oregano)'],
      [null, 'aalt and pepper'],
    ],
    modifications: [
      {
        title: 'To serve:',
        list: [
          [400, 'spaghetti, dried'],
          [null, 'parmesan cheese and finely chopped parsley (optional)'],
        ],
      },
    ],
    instructions: [
    ...
    time_total: '1 hour',
    image:
      'https://res.cloudinary.com/dq1embvfh/image/upload/v1603629143/spaghetti-bolognese.jpg',
    video: 'https://www.youtube.com/watch?v=yShBC-G-jrQ',
  },
  {
    name: 'СИРНИКИ',
    id: 23,
    ...
    tags: ['syrnyky'],
    category: ['dessert'],
    description: `Прості речі часом виявляються набагато складнішими, ніж здаються. З сирниками та ж сама історія. Звичайно, для досвідчених господинь ця страва настільки звична, що і говорити про це не слід. Але, як виявилося, приготування смачних сирників справа не така вже й проста і у багатьох викликає складнощі. Я вирішив виправити такий стан речей і хочу поділитися з вами простим рецептом сирників, за яким вони завжди виходять. А якщо ви захочете прокачати рецепт, спробуйте приготувати сирники з маком.`,
    ingridients: [
      [400, 'г сиру (творогу, 9% жирності)'],
      [1, 'яйце'],
      [3, 'ст. л. борошна (і додатково для паніровки)'],
      [3, 'ст. л. цукру'],
      [4, 'ст. л. соняшникової олії для смаження'],
      [1, 'дрібка солі'],
      [10, 'г ванільного цукру'],
    ],
    instructions: [
      `Сир (400 г) перекладіть в невелику скляну або пластикову миску. Додайте дрібку солі, одне яйце, 3 ст. л. цукру, і 10 г ванільного цукру. Я не люблю, щоб сирники були занадто солодкими, але ви можете додати трохи більше цукру, наприклад 4 ст. л. Сир для сирників можна використовувати як базарний, так і магазинний. Головне, щоб він був не кислим і сильно вологим. Якщо використовуєте магазинний сир, то беріть сир в м'яких поліетиленових пакетах.`,
    ...
    time_total: '30 хв',
    image:
      'https://res.cloudinary.com/dq1embvfh/image/upload/v1604318384/syrnyky.jpg',
  ...
  },
  {
    ...
    type: 'liked',
    servings: 4,
    slugUrl: 'banana-pancakes',
    lang: 'en',
    tags: ['pancakes', 'banana'],
    category: ['dessert'],
    ...
    instructions: [
      ...
      `Cook: heat a medium skillet over medium heat, spray with cooking spray or add a little butter if needed. Drop one tablespoon of batter on the skillet and let cook for 3-4 minutes or until the sides are starting to become firm and the bottoms are golden brown. You will not see any bubbles like traditional pancakes. `,
  ...
  },
  {
    ...
    type: 'liked',
    servings: 4,
    slugUrl: 'cuketove-placky',
    lang: 'en',
    tags: ['placky', 'cuketa'],
    category: ['main dish'],
    description: `Cukety jsou výbornou sezónní surovinou, která se dá zpracovat na mnoho způsobů. Cuketové placky si vás získají svojí jemnou chutí a křehkou konzistencí.`,
    ingridients: [
      [500, ' g cukety'],
      [3, 'vejce'],
      [4, 'vrchovatých lžic hladké mouky'],
      [2, 'zarovnané lžičky mletého kmínu'],
      [3, 'lžičky soli'],
      [6, 'středních stroužků česneku'],
      [null, 'tuk na smažení'],
    ],
    instructions: [
      `Cuketu oloupeme a nastrouháme na hrubo. U přezrálejší odstraníme změklý vnitřek se semeny. Nastrouhanou cuketu osolíme, zamícháme a necháme zhruba 1/2 hodiny odpočinout.`,
      `Vodu, kterou potom osolená masa cukety pustí, slijeme a hmotu ještě rukama vymačkáme a všechnu vodu vylijeme. Do této hmoty bez vody přidáme vejce, kmín a 2 špetky soli.`,
      `Přidáme mouku a umícháme těsto, které bude hustší, než na jaké jsme zvyklí, když děláme bramborák. Pokud je těsto řídké, přidáme ještě mouku.`,
      `Z připraveného těsta smažíme placky. Těsto nabíráme lžící a na pánvi z něj tvarujeme menší a poněkud silnější placky. Placky se opékají z obou stran dozlatova. Musejí mít opečený povrch a vnitřek trochu měkčí. Z uvedeného množství uděláme asi 8 menších placek.`,

    ],
    time_prep: '20 min',
    time_cook: '40 min',
    time_total: '60 min',
    image: 'https://res.cloudinary.com/dq1embvfh/image/upload/v1659005586/placky.jpg',
    video: null,
  },
];